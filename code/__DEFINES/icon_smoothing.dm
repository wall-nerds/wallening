...
#define SMOOTH_GROUP_SHIELD_GEN_WALL S_OBJ(77) // /obj/machinery/shieldwall
#define SMOOTH_GROUP_GLITTER_PINK S_OBJ(78) // /obj/effect/decal/cleanable/glitter/pink
#define SMOOTH_GROUP_GLITTER_WHITE S_OBJ(79) // /obj/effect/decal/cleanable/glitter/white
#define SMOOTH_GROUP_GLITTER_BLUE S_OBJ(80) // /obj/effect/decal/cleanable/glitter/blue
