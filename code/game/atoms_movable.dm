...
/atom/movable/proc/do_attack_animation(atom/attacked_atom, visual_effect_icon, obj/item/used_item, no_effect, blind_effect = TRUE)
	...
	if(blind_effect)
		play_blind_effect(attacked_atom, 5, "attack")
